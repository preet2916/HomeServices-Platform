...
<body>
 <!-- Top Navbar -->
 <nav class="navbar navbar-dark fixed-top bg-danger flex-md-nowrap p-0 shadow" style="background-color:black !important;">
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="RequesterProfile.php">Home Services</a>
 </nav>
